...
const englishContent = {
  shell: {
    ...
    scopeDescription:
      "Wallet reads are live only when connected. Market rows are seeded fallback data; local Anvil can provide live incubation contract reads.",
    overviewLabel: "Mission control",
    overviewTitle: "Continuous builder discovery, from first signal to milestone release",
    updatedAt: "P0.8 submission build",
    badges: [
      { label: "AI x Web3", tone: "accent" as const },
      { label: "Local Anvil reproducible", tone: "positive" as const },
      { label: "Trusted P0 roles", tone: "caution" as const },
    ],
    statusLegend: [
      {
        label: "Implemented",
        detail: "Contracts, AI reports, settlement flow, reputation, and incubation accounting are verifiable in this repository.",
        tone: "positive" as const,
      },
      {
        label: "Demo-grade",
        detail: "Seeded market data, sponsor units, and trusted reviewer actions are explicit prototype boundaries.",
        tone: "caution" as const,
      },
      {
        label: "Roadmap",
        detail: "Optimistic oracle challenges, production custody, and HTX resource integrations are not implemented.",
        tone: "neutral" as const,
      },
    ],
  },
  hero: {
    eyebrow: "Builder lifecycle infrastructure",
    title: "Most hackathons stop at ranking. Veil Scout turns ranking into continuous builder discovery and milestone-based incubation.",
    description:
      "AI proposes a falsifiable prior, scouts challenge it with non-transferable credits, a trusted P0 oracle verifies execution, and selected builders continue through milestone-gated incubation.",
    primaryCta: "Open approval review",
    connectCta: "Connect wallet",
    secondaryCta: "View settlement path",
    highlights: [
      "Implemented: AI Prior, Crowd Odds, contracts, reports, settlement, and reputation",
      "Demo-grade: trusted roles, seeded market rows, and sponsor-unit accounting",
      "Roadmap: optimistic oracle challenges and production ecosystem integrations",
    ],
    summaryTitle: "Lifecycle snapshot",
    summary: [
      { label: "AI signal", value: "AI Prior 64%" },
      { label: "Human signal", value: "Crowd Odds 58%" },
      { label: "Settlement boundary", value: "Trusted P0 oracle" },
      { label: "Incubation accounting", value: "Sponsor units (demo)" },
    ],
    note:
  ...
  incubation: {
    ...
    executionBadge: "Demo-grade evidence: seeded follow-through",
    statusLabel: "ACTIVE",
    ...
    liveDataLabel: "Implemented / Local contract read",
    fallbackDataLabel: "Demo-grade / Seeded fallback",
    totalBudget: 12_000,
  ...
  flow: {
    eyebrow: "One builder lifecycle",
    title: "Discovery becomes accountable follow-through",
    steps: [
      {
        title: "Discover",
        detail: "AI turns public project evidence into a structured, falsifiable AI Prior.",
        state: "complete" as const,
      },
      {
        title: "Compare",
        detail: "Scouts allocate non-transferable credits, producing Crowd Odds that can challenge the AI.",
        state: "complete" as const,
      },
      {
        title: "Verify",
        detail: "The trusted P0 oracle checks explicit GitHub or on-chain execution criteria.",
        state: "current" as const,
      },
      {
        title: "Settle",
        detail: "An authorized role settles the market and the contracts update scout reputation.",
        state: "upcoming" as const,
      },
      {
        title: "Incubate",
        detail: "Selected builders enter a separate milestone lane; scout credits never become sponsor funds.",
        state: "upcoming" as const,
      },
      {
        title: "Release",
        detail: "An authorized reviewer releases a fixed sponsor-unit tranche after evidence review.",
        state: "upcoming" as const,
      },
    ],
  },
...
const chineseContent: typeof englishContent = {
  shell: {
    ...
    scopeLabel: "演示范围",
    scopeDescription:
      "只有连接钱包后的地址与余额才是实时读取；市场行为种子回退数据，本地 Anvil 可提供孵化合约实时读取。",
    overviewLabel: "主控舱",
    overviewTitle: "从第一轮信号到里程碑释放的持续 builder 发现",
    updatedAt: "P0.8 提交版本",
    badges: [
      { label: "AI x Web3", tone: "accent" as const },
      { label: "本地 Anvil 可复现", tone: "positive" as const },
      { label: "P0 可信角色", tone: "caution" as const },
    ],
    statusLegend: [
      {
        label: "已实现",
        detail: "合约、AI 报告、结算链路、声誉与孵化记账均可在仓库中验证。",
        tone: "positive" as const,
      },
      {
        label: "Demo 级",
        detail: "种子市场数据、sponsor units 与可信 reviewer 操作均为明确的原型边界。",
        tone: "caution" as const,
      },
      {
        label: "路线图",
        detail: "乐观预言机挑战、生产托管与 HTX 资源集成尚未实现。",
        tone: "neutral" as const,
      },
    ],
  },
  hero: {
    eyebrow: "Builder 全生命周期基础设施",
    title: "大多数黑客松止步于排名。Veil Scout 把排名转化为持续的 builder 发现与里程碑孵化。",
    description:
      "AI 提出可证伪的先验，Scout 用不可转让积分纠偏，P0 可信预言机验证执行证据，入选 builder 再进入里程碑孵化通道。",
    primaryCta: "进入审批复核",
    connectCta: "连接钱包",
    secondaryCta: "查看结算路径",
    highlights: [
      "已实现：AI Prior、Crowd Odds、合约、报告、结算与声誉",
      "Demo 级：可信角色、种子市场行与 sponsor-unit 记账",
      "路线图：乐观预言机挑战与生产生态集成",
    ],
    summaryTitle: "生命周期快照",
    summary: [
      { label: "AI 信号", value: "AI Prior 64%" },
      { label: "群体信号", value: "Crowd Odds 58%" },
      { label: "结算边界", value: "P0 可信预言机" },
      { label: "孵化记账", value: "Sponsor units（demo）" },
    ],
    note:
  ...
  incubation: {
    ...
    selectedProject: "AgentPay",
    executionBadge: "Demo 级证据：种子持续交付",
    statusLabel: "ACTIVE",
    statusTone: "positive" as StatusTone,
    ...
    liveDataLabel: "已实现 / 本地合约读取",
    fallbackDataLabel: "Demo 级 / 种子回退数据",
    totalBudget: 12_000,
    releasedBudget: 4_000,
    refundedBudget: 0,
    remainingBudget: 8_000,
  ...
  flow: {
    eyebrow: "同一条 Builder 生命周期",
    title: "从发现信号到可问责的持续交付",
    steps: [
      {
        title: "发现",
        detail: "AI 把项目公开证据整理成结构化、可证伪的 AI Prior。",
        state: "complete" as const,
      },
      {
        title: "比较",
        detail: "Scout 分配不可转让积分，用 Crowd Odds 对 AI 判断进行确认或纠偏。",
        state: "complete" as const,
      },
      {
        title: "验证",
        detail: "P0 可信预言机按照明确的 GitHub 或链上标准检查执行证据。",
        state: "current" as const,
      },
      {
        title: "结算",
        detail: "授权角色提交市场结果，合约据此更新 Scout 声誉。",
        state: "upcoming" as const,
      },
      {
        title: "孵化",
        detail: "入选 builder 进入独立里程碑通道；Scout 积分不会变成 sponsor 资金。",
        state: "upcoming" as const,
      },
      {
        title: "释放",
        detail: "授权 reviewer 审核证据后，释放固定 sponsor-unit tranche。",
        state: "upcoming" as const,
      },
    ],
  },
